...
public interface ConcurrencyOrBuilder extends
   ...
   */
  long getBatchReadTimestamp();

  public com.google.spanner.executor.v1.Concurrency.ConcurrencyModeCase getConcurrencyModeCase();
}
