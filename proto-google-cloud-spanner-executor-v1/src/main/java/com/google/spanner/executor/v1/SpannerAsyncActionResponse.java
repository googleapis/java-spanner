 ...
 */
public final class SpannerAsyncActionResponse extends com.google.protobuf.GeneratedMessageV3
    implements
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(getOutcomeFieldBuilder().getBuilder(), extensionRegistry);
