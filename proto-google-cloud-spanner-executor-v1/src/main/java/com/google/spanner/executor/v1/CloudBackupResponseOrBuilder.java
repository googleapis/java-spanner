...
public interface CloudBackupResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.spanner.admin.database.v1.Backup> 
      getListedBackupList();
  /**
   * <pre>
   * List of backups returned by ListCloudBackupsAction.
   ...
   * <code>repeated .google.spanner.admin.database.v1.Backup listed_backup = 2;</code>
   */
  com.google.spanner.admin.database.v1.Backup getListedBackup(int index);
  /**
   * <pre>
   * List of backups returned by ListCloudBackupsAction.
   * </pre>
   ...
   * <code>repeated .google.spanner.admin.database.v1.Backup listed_backup = 2;</code>
   */
  com.google.spanner.admin.database.v1.BackupOrBuilder getListedBackupOrBuilder(
      int index);
