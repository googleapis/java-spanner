      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(getBackupResponseFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 18:
              {
                input.readMessage(
                    getOperationResponseFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 26:
              {
                input.readMessage(
                    getDatabaseResponseFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 34:
              {
                input.readMessage(
                    getInstanceResponseFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 42:
              {
                input.readMessage(
                    getInstanceConfigResponseFieldBuilder().getBuilder(), extensionRegistry);
