 ...
 */
public final class Concurrency extends
...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 72: {
            ...
            batchReadTimestamp_ = input.readInt64();
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.spanner.executor.v1.ExecutorProto.internal_static_google_spanner_executor_v1_Concurrency_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.spanner.executor.v1.ExecutorProto.internal_static_google_spanner_executor_v1_Concurrency_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.spanner.executor.v1.Concurrency.class, com.google.spanner.executor.v1.Concurrency.Builder.class);
  }
  ...
  public enum ConcurrencyModeCase
    ...
    public static ConcurrencyModeCase forNumber(int value) {
      switch (value) {
        case 1: return STALENESS_SECONDS;
        case 2: return MIN_READ_TIMESTAMP_MICROS;
        case 3: return MAX_STALENESS_SECONDS;
        case 4: return EXACT_TIMESTAMP_MICROS;
        case 5: return STRONG;
        case 6: return BATCH;
        case 0: return CONCURRENCYMODE_NOT_SET;
        default: return null;
      }
    }
  ...
  public ConcurrencyModeCase
  getConcurrencyModeCase() {
    return ConcurrencyModeCase.forNumber(
        concurrencyModeCase_);
  }
  ...
  /**
   * <pre>
   * must only be set to true, or unset.
   * </pre>
   *
  ...
  public static final int BATCH_READ_TIMESTAMP_FIELD_NUMBER = 9;
  private long batchReadTimestamp_;
  /**
   * <pre>
   * Set only when batch is true.
   * </pre>
   *
   * <code>int64 batch_read_timestamp = 9;</code>
   * @return The batchReadTimestamp.
   */
  @java.lang.Override
  public long getBatchReadTimestamp() {
    return batchReadTimestamp_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (batchReadTimestamp_ != 0L) {
      output.writeInt64(9, batchReadTimestamp_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (snapshotEpochRead_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(7, snapshotEpochRead_);
    }
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(snapshotEpochRootTable_)) {
    ...
    if (batchReadTimestamp_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(9, batchReadTimestamp_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.spanner.executor.v1.Concurrency other = (com.google.spanner.executor.v1.Concurrency) obj;

    if (getSnapshotEpochRead()
        != other.getSnapshotEpochRead()) return false;
    if (!getSnapshotEpochRootTable()
        .equals(other.getSnapshotEpochRootTable())) return false;
    if (getBatchReadTimestamp()
        != other.getBatchReadTimestamp()) return false;
      ...
      case 1:
        if (java.lang.Double.doubleToLongBits(getStalenessSeconds())
            != java.lang.Double.doubleToLongBits(
                other.getStalenessSeconds())) return false;
        break;
      case 2:
        if (getMinReadTimestampMicros()
            != other.getMinReadTimestampMicros()) return false;
        break;
      case 3:
        if (java.lang.Double.doubleToLongBits(getMaxStalenessSeconds())
            != java.lang.Double.doubleToLongBits(
                other.getMaxStalenessSeconds())) return false;
        break;
      case 4:
        if (getExactTimestampMicros()
            != other.getExactTimestampMicros()) return false;
        break;
      case 5:
        if (getStrong()
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + BATCH_READ_TIMESTAMP_FIELD_NUMBER;
    hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
        getBatchReadTimestamp());
    switch (concurrencyModeCase_) {
      case 1:
  ...
  public static com.google.spanner.executor.v1.Concurrency parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public com.google.spanner.executor.v1.Concurrency buildPartial() {
      com.google.spanner.executor.v1.Concurrency result = new com.google.spanner.executor.v1.Concurrency(this);
      if (concurrencyModeCase_ == 1) {
      ...
      result.batchReadTimestamp_ = batchReadTimestamp_;
    ...
    public Builder mergeFrom(com.google.spanner.executor.v1.Concurrency other) {
      ...
      if (other.getBatchReadTimestamp() != 0L) {
        setBatchReadTimestamp(other.getBatchReadTimestamp());
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.spanner.executor.v1.Concurrency parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.spanner.executor.v1.Concurrency) e.getUnfinishedMessage();
     ...
     * @return This builder for chaining.
     */
    public Builder setSnapshotEpochRootTableBytes(
  ...
  checkByteStringIsUtf8(value);
     ...
     *
     * <code>int64 batch_read_timestamp = 9;</code>
     * @param value The batchReadTimestamp to set.
     * @return This builder for chaining.
     */
    public Builder setBatchReadTimestamp(long value) {
      
      batchReadTimestamp_ = value;
      onChanged();
      return this;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder clearBatchReadTimestamp() {
  ...
  private static final com.google.protobuf.Parser<Concurrency>
      PARSER = new com.google.protobuf.AbstractParser<Concurrency>() {
    @java.lang.Override
    public Concurrency parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new Concurrency(input, extensionRegistry);
    }
  };
