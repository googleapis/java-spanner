...
public class ITResultSetGetValue {
  ...
  public void testReadNullInArrays() {
    databaseClient.write(
        Collections.singletonList(
            Mutation.newInsertBuilder(TABLE_NAME)
                ...
                .to(2L)
                .set("boolArray")
                .toBoolArray(Arrays.asList(null, true))
                .set("int64Array")
                .toInt64Array(Arrays.asList(100L, null))
                .set("float64Array")
                .toFloat64Array(Arrays.asList(null, 2000D))
                .set("numericArray")
    ...
    try (ResultSet resultSet =
      ...
      assertEquals(Value.boolArray(Arrays.asList(null, true)), resultSet.getValue("boolArray"));
      assertEquals(Value.int64Array(Arrays.asList(100L, null)), resultSet.getValue("int64Array"));
      assertNull(resultSet.getValue("float64Array").getFloat64Array().get(0));
      assertEquals(2000D, resultSet.getValue("float64Array").getFloat64Array().get(1), DELTA);
      assertEquals(
