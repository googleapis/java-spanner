...
public class ITAutogeneratedAdminClientTest {
  ...
  public static List<DatabaseDialect> data() {
    return ImmutableList.of(
        DatabaseDialect.GOOGLE_STANDARD_SQL, DatabaseDialect.POSTGRESQL);
  }
  ...
  public static void setUp() {
    ...
    dbAdminClient = testHelper.getClient().databaseAdminClient();
  ...
  public void grantAndRevokeDatabaseRolePermissions() throws Exception {
    ...
    DatabaseClient dbClient = spanner.getDatabaseClient(createdDatabase.getName());
  ...
  public void roleWithNoPermissions() throws Exception {
    ...
    final Database createdDatabase =
        createAndUpdateDatabase(testHelper.getOptions().getProjectId(),
  ...
  private Database createAndUpdateDatabase(
      String projectId, final InstanceId instanceId, final String databaseId, final List<String> statements)
      throws Exception {
    if (dialect == DatabaseDialect.POSTGRESQL) {
      ...
      Database database = dbAdminClient
       ...
       dbAdminClient
          .updateDatabaseDdlAsync(database.getName(), statements).get(5, TimeUnit.MINUTES);
      return database;
    } else {
      CreateDatabaseRequest createDatabaseRequest =
          CreateDatabaseRequest.newBuilder()
              ...
              .addAllExtraStatements(statements).build();
