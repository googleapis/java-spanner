...
public class ConnectionImplGeneratedSqlScriptTest extends AbstractSqlScriptTest {
   ...
   * mvn -Pgenerate-test-sql-scripts compile</code>
   */
  static void generateTestScript(Dialect dialect) throws ClassNotFoundException, IOException {
    // first make the current script file empty
    AbstractConnectionImplTest.emptyScript(dialect);
