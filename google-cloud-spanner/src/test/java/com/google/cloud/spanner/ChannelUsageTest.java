...
public class ChannelUsageTest {
  ...
  private static Set<InetSocketAddress> batchCreateSessionLocalIps = ConcurrentHashMap.newKeySet();
  private static Set<InetSocketAddress> executeSqlLocalIps = ConcurrentHashMap.newKeySet();
