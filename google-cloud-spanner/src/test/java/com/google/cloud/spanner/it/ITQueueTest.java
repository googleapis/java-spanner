...
public class ITQueueTest {
  ...
  private Struct readRow(String queue, Key key, String... columns) {
    return client
        ...
        .readRow(queue, key, Arrays.asList(columns));
  }
  ...
  public void testAckNotFound() {
    ...
    client.write(Collections.singletonList(
        Mutation.newAckBuilder("Q1")
            .setKey(Key.of(1))
    ...
    SpannerException thrown = assertThrows(SpannerException.class, () -> client.write(Collections.singletonList(
        Mutation.newAckBuilder("Q1")
            .setKey(Key.of(1))
