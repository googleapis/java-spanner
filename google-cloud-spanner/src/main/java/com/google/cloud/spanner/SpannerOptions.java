...
public class SpannerOptions extends ServiceOptions<Spanner, SpannerOptions> {
  ...
  private final boolean canUseDirectPath;
  ...
  protected SpannerOptions(Builder builder) {
    ...
    canUseDirectPath = builder.canUseDirectPath;
  }
  ...
  public static class Builder
    ...
    private boolean canUseDirectPath = false;
    ...
    @InternalApi
    public Builder canUseDirectPath(boolean canUseDirectPath) {
      this.canUseDirectPath = canUseDirectPath;
      return this;
    }
  ...
  public ApiTracerFactory getApiTracerFactory() {
    ...
    if (isEnableBuiltInMetrics()) {
      ApiTracerFactory metricsTracerFactory = getMetricsApiTracerFactory(canUseDirectPath);
  ...
  private ApiTracerFactory getMetricsApiTracerFactory(boolean canUseDirectPath) {
    BuiltInOpenTelemetryMetricsProvider builtInOpenTelemetryMetricsProvider =
        new BuiltInOpenTelemetryMetricsProvider();
    OpenTelemetry openTelemetry =
        builtInOpenTelemetryMetricsProvider.getOpenTelemetry(
    ...
    return openTelemetry != null
        ? new MetricsTracerFactory(
            ...
            builtInOpenTelemetryMetricsProvider.getClientAttributes(
                getDefaultProjectId(), canUseDirectPath))
        : null;
  }
