...
public final class ChannelFinder {
  ...
  public ChannelFinderServer findServer(ReadRequest.Builder reqBuilder) {
    ...
    try {
      ...
      // Note: In C++, fingerprint is computed before taking the lock.
      // For simplicity and direct translation, computing it inside.
      // KeyRecipeCache.fingerprint is static and doesn't rely on instance state changed by
      // update().
