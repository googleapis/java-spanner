...
// [START spanner_copy_backup_with_multiple_encryption_key]
...
public class CopyBackupWithMultipleEncryptionKey {
  static void copyBackupWithMultipleEncryptionKey() {
    ...
    try (Spanner spanner =
      ...
      copyBackupWithMultipleEncryptionKey(databaseAdminClient, projectId, instanceId, sourceBackupId, destinationBackupId);
    }
  }
...
// [END spanner_copy_backup_with_multiple_encryption_key]
