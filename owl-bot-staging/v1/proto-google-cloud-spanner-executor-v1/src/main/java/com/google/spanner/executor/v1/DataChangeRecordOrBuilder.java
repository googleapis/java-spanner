...
public interface DataChangeRecordOrBuilder extends
   ...
   */
  java.util.List<com.google.spanner.executor.v1.DataChangeRecord.ColumnType> 
      getColumnTypesList();
  /**
   * <pre>
   * Column types defined in the schema.
   ...
   */
  java.util.List<com.google.spanner.executor.v1.DataChangeRecord.Mod> 
      getModsList();
  /**
   * <pre>
   * Changes made in the transaction.
   ...
   * <code>repeated .google.spanner.executor.v1.DataChangeRecord.Mod mods = 7;</code>
   */
  com.google.spanner.executor.v1.DataChangeRecord.ModOrBuilder getModsOrBuilder(
      int index);
