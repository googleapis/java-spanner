...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.spanner.executor.v1.SpannerActionOutcome result) {
      if (dbPartitionBuilder_ == null) {
        if (((bitField0_ & 0x00000040) != 0)) {
    ...
    private void buildPartial0(com.google.spanner.executor.v1.SpannerActionOutcome result) {
      ...
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.readResult_ = readResultBuilder_ == null
            ? readResult_
            : readResultBuilder_.build();
      ...
      if (((from_bitField0_ & 0x00000080) != 0)) {
        result.adminResult_ = adminResultBuilder_ == null
            ? adminResult_
            : adminResultBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  getReadResultFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 58: {
              com.google.spanner.executor.v1.BatchPartition m =
                  input.readMessage(
                      com.google.spanner.executor.v1.BatchPartition.parser(),
                      extensionRegistry);
              if (dbPartitionBuilder_ == null) {
                ensureDbPartitionIsMutable();
                dbPartition_.add(m);
            ...
            case 66: {
              input.readMessage(
                  getAdminResultFieldBuilder().getBuilder(),
                  extensionRegistry);
