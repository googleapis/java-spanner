...
java.lang.String defaultValue) {
  ...
  public int getSerializedSize() {
    ...
    if (multiplexed_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(6, multiplexed_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getCreatorRole()
        .equals(other.getCreatorRole())) return false;
    if (getMultiplexed()
        != other.getMultiplexed()) return false;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.spanner.v1.Session result) {
      ...
      if (((from_bitField0_ & 0x00000008) != 0)) {
        result.approximateLastUseTime_ = approximateLastUseTimeBuilder_ == null
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              input.readMessage(
                  getApproximateLastUseTimeFieldBuilder().getBuilder(),
                  extensionRegistry);
...
java.lang.String defaultValue) {
     ...
     * @return This builder for chaining.
     */
    public Builder setCreatorRoleBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      creatorRole_ = value;
