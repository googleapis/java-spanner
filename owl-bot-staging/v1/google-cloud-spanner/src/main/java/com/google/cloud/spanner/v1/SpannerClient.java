 ...
 *    <tr>
 *      <td>CreateSession</td>
 *      <td><p>Creates a new session. A session can be used to perform
 ...
 *  periodically, e.g., `"SELECT 1"`.</p></td>
 *      <td>
 ...
 *      <ul>
 *           <li>createSession(DatabaseName database)
 *           <li>createSession(String database)
 *      </ul>
 ...
 *    </tr>
 *    <tr>
 *      <td>BatchCreateSessions</td>
 *      <td><p>Creates multiple new sessions.
 *
 *  This API can be used to initialize a session cache on the clients.
 *  See https://goo.gl/TgSFN2 for best practices on session cache management.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>batchCreateSessions(BatchCreateSessionsRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>batchCreateSessions(DatabaseName database, int sessionCount)
 *           <li>batchCreateSessions(String database, int sessionCount)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>batchCreateSessionsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>GetSession</td>
 *      <td><p>Gets a session. Returns `NOT_FOUND` if the session does not exist.
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>getSession(SessionName name)
 *           <li>getSession(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>ListSessions</td>
 *      <td><p>Lists all sessions in a given database.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>listSessions(DatabaseName database)
 *           <li>listSessions(String database)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>DeleteSession</td>
 *      <td><p>Ends a session, releasing server resources associated with it. This will
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>deleteSession(SessionName name)
 *           <li>deleteSession(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>ExecuteSql</td>
 *      <td><p>Executes an SQL statement, returning all results in a single reply. This
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>executeSql(ExecuteSqlRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>executeSqlCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>ExecuteStreamingSql</td>
 *      <td><p>Like [ExecuteSql][google.spanner.v1.Spanner.ExecuteSql], except returns the
 *  result set as a stream. Unlike
 *  [ExecuteSql][google.spanner.v1.Spanner.ExecuteSql], there is no limit on
 *  the size of the returned result set. However, no individual row in the
 *  result set can exceed 100 MiB, and no column value can exceed 10 MiB.</p></td>
 *      <td>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>executeStreamingSqlCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>ExecuteBatchDml</td>
 *      <td><p>Executes a batch of SQL DML statements. This method allows many statements
 ...
 *  are not executed.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>executeBatchDml(ExecuteBatchDmlRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>executeBatchDmlCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>Read</td>
 *      <td><p>Reads rows from the database using key lookups and scans, as a
 ...
 *  [StreamingRead][google.spanner.v1.Spanner.StreamingRead] instead.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>read(ReadRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>readCallable()
 ...
 *    <tr>
 *      <td>StreamingRead</td>
 *      <td><p>Like [Read][google.spanner.v1.Spanner.Read], except returns the result set
 ...
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>streamingReadCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>BeginTransaction</td>
 *      <td><p>Begins a new transaction. This step can often be skipped:
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>beginTransaction(SessionName session, TransactionOptions options)
 *           <li>beginTransaction(String session, TransactionOptions options)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>Commit</td>
 *      <td><p>Commits a transaction. The request includes the mutations to be
 ...
 *  state of things as they are now.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>commit(SessionName session, ByteString transactionId, List<Mutation> mutations)
 *           <li>commit(SessionName session, TransactionOptions singleUseTransaction, List<Mutation> mutations)
 *           <li>commit(String session, ByteString transactionId, List<Mutation> mutations)
 *           <li>commit(String session, TransactionOptions singleUseTransaction, List<Mutation> mutations)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>commitCallable()
 ...
 *    <tr>
 *      <td>Rollback</td>
 *      <td><p>Rolls back a transaction, releasing any locks it holds. It is a good
 ...
 *  found. `Rollback` never returns `ABORTED`.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>rollback(SessionName session, ByteString transactionId)
 *           <li>rollback(String session, ByteString transactionId)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>rollbackCallable()
 ...
 *      <td><p>Creates a set of partition tokens that can be used to execute a query
 ...
 *  the whole operation must be restarted from the beginning.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>PartitionRead</td>
 *      <td><p>Creates a set of partition tokens that can be used to execute a read
 *  operation in parallel.  Each of the returned partition tokens can be used
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>partitionRead(PartitionReadRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>partitionReadCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>BatchWrite</td>
 *      <td><p>Batches the supplied mutation groups in a collection of efficient
 ...
 *  idempotent to avoid this issue.</p></td>
 *      <td>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
