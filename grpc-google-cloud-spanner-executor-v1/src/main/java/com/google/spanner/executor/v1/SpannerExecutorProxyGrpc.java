...
public final class SpannerExecutorProxyGrpc {
  ...
  public static final String SERVICE_NAME = "google.spanner.executor.v1.SpannerExecutorProxy";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.spanner.executor.v1.SpannerAsyncActionRequest,
      com.google.spanner.executor.v1.SpannerAsyncActionResponse> getExecuteActionAsyncMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.spanner.executor.v1.SpannerAsyncActionRequest,
      com.google.spanner.executor.v1.SpannerAsyncActionResponse> getExecuteActionAsyncMethod() {
    io.grpc.MethodDescriptor<com.google.spanner.executor.v1.SpannerAsyncActionRequest, com.google.spanner.executor.v1.SpannerAsyncActionResponse> getExecuteActionAsyncMethod;
    if ((getExecuteActionAsyncMethod = SpannerExecutorProxyGrpc.getExecuteActionAsyncMethod) == null) {
      synchronized (SpannerExecutorProxyGrpc.class) {
        if ((getExecuteActionAsyncMethod = SpannerExecutorProxyGrpc.getExecuteActionAsyncMethod) == null) {
          SpannerExecutorProxyGrpc.getExecuteActionAsyncMethod = getExecuteActionAsyncMethod =
              io.grpc.MethodDescriptor.<com.google.spanner.executor.v1.SpannerAsyncActionRequest, com.google.spanner.executor.v1.SpannerAsyncActionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExecuteActionAsync"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.spanner.executor.v1.SpannerAsyncActionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.spanner.executor.v1.SpannerAsyncActionResponse.getDefaultInstance()))
              .setSchemaDescriptor(new SpannerExecutorProxyMethodDescriptorSupplier("ExecuteActionAsync"))
              .build();
        }
      }
    }
  ...
  public static SpannerExecutorProxyStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SpannerExecutorProxyStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<SpannerExecutorProxyStub>() {
        @java.lang.Override
        public SpannerExecutorProxyStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static SpannerExecutorProxyBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<SpannerExecutorProxyBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<SpannerExecutorProxyBlockingStub>() {
        @java.lang.Override
        public SpannerExecutorProxyBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static SpannerExecutorProxyFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SpannerExecutorProxyFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<SpannerExecutorProxyFutureStub>() {
        @java.lang.Override
        public SpannerExecutorProxyFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static abstract class SpannerExecutorProxyImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.google.spanner.executor.v1.SpannerAsyncActionRequest> executeActionAsync(
        io.grpc.stub.StreamObserver<com.google.spanner.executor.v1.SpannerAsyncActionResponse> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getExecuteActionAsyncMethod(), responseObserver);
    }
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                ...
                com.google.spanner.executor.v1.SpannerAsyncActionResponse>(
                  this, METHODID_EXECUTE_ACTION_ASYNC)))
          .build();
    }
  }
  ...
  public static final class SpannerExecutorProxyStub extends io.grpc.stub.AbstractAsyncStub<SpannerExecutorProxyStub> {
    private SpannerExecutorProxyStub(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    private final SpannerExecutorProxyImplBase serviceImpl;
    private final int methodId;

    MethodHandlers(SpannerExecutorProxyImplBase serviceImpl, int methodId) {
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_EXECUTE_ACTION_ASYNC:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.executeActionAsync(
              (io.grpc.stub.StreamObserver<com.google.spanner.executor.v1.SpannerAsyncActionResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
  ...
  private static abstract class SpannerExecutorProxyBaseDescriptorSupplier
  ...
  private static final class SpannerExecutorProxyMethodDescriptorSupplier
    ...
    SpannerExecutorProxyMethodDescriptorSupplier(String methodName) {
