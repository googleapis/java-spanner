...
```Groovy
implementation 'com.google.cloud:google-cloud-spanner:6.80.1'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-spanner" % "6.80.1"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-spanner/6.80.1
