  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\016last_statement\030\021 \001(\010B\003\340A\001\0224\n"
          + "\014routing_hint\030c \001(\0132\036.google.spanner.v1.RoutingHint\032O\n"
          ...
          + "panner.v1.ExecuteBatchDmlRequest.StatementB\003\340A\002\022\022\n"
          ...
          + "\013param_types\030\003 \003(\0132C.google.spanner.v1.ExecuteB"
          + "atchDmlRequest.Statement.ParamTypesEntry\032J\n"
          + "\017ParamTypesEntry\022\013\n"
          + "\003key\030\001 \001(\t\022&\n"
          ...
          + "\013transaction\030\002 \001(\0132\036.google.spanner.v1.Transaction\"\254\006\n"
          + "\013ReadRequest\0227\n"
          + "\007session\030\001 \001(\tB&\340A\002\372A \n"
          + "\036spanner.googleapis.com/Session\022;\n"
          + "\013transaction\030\002 \001(\0132&.google.spanner.v1.TransactionSelector\022\022\n"
          ...
          + "\010order_by\030\020 \001(\0162"
          + "&.google.spanner.v1.ReadRequest.OrderByB\003\340A\001\022?\n"
          + "\tlock_hint\030\021"
          + " \001(\0162\'.google.spanner.v1.ReadRequest.LockHintB\003\340A\001\0224\n"
          + "\014routing_hint\030c \001(\0132\036.google.spanner.v1.RoutingHint\"T\n"
          + "\007OrderBy\022\030\n"
          ...
          + "\017precommit_token\030\t \001(\01323.google"
          + ".spanner.v1.MultiplexedSessionPrecommitTokenB\003\340A\001B\r\n"
          + "\013transaction\"g\n"
          ...
          + "CreateSession\022\'.google.spanner.v1.CreateSessionRequest\032\032.google.span"
          + "ner.v1.Session\"P\332A\010database\202\323\344\223\002?\":/v1/{"
          + "database=projects/*/instances/*/databases/*}/sessions:\001*\022\340\001\n"
          + "\023BatchCreateSessions\022-.google.spanner.v1.BatchCreateSessions"
          + "Request\032..google.spanner.v1.BatchCreateS"
          + "essionsResponse\"j\332A\026database,session_cou"
          + "nt\202\323\344\223\002K\"F/v1/{database=projects/*/insta"
          + "nces/*/databases/*}/sessions:batchCreate:\001*\022\227\001\n\n"
          + "GetSession\022$.google.spanner.v1.GetSessionRequest\032\032.google.spanner.v1.Ses"
          + "sion\"G\332A\004name\202\323\344\223\002:\0228/v1/{name=projects/"
          + "*/instances/*/databases/*/sessions/*}\022\256\001\n"
          + "\014ListSessions\022&.google.spanner.v1.ListS"
          + "essionsRequest\032\'.google.spanner.v1.ListS"
          + "essionsResponse\"M\332A\010database\202\323\344\223\002<\022:/v1/"
          + "{database=projects/*/instances/*/databases/*}/sessions\022\231\001\n\r"
          + "DeleteSession\022\'.google.spanner.v1.DeleteSessionRequest\032\026.goog"
          + "le.protobuf.Empty\"G\332A\004name\202\323\344\223\002:*8/v1/{n"
          + "ame=projects/*/instances/*/databases/*/sessions/*}\022\243\001\n\n"
          + "ExecuteSql\022$.google.spanner.v1.ExecuteSqlRequest\032\034.google.spanner"
          + ".v1.ResultSet\"Q\202\323\344\223\002K\"F/v1/{session=proj"
          + "ects/*/instances/*/databases/*/sessions/*}:executeSql:\001*\022\276\001\n"
          + "\023ExecuteStreamingSql\022$.google.spanner.v1.ExecuteSqlRequest\032#"
          + ".google.spanner.v1.PartialResultSet\"Z\202\323\344"
          + "\223\002T\"O/v1/{session=projects/*/instances/*"
          + "/databases/*/sessions/*}:executeStreamingSql:\001*0\001\022\300\001\n"
          + "\017ExecuteBatchDml\022).google.spanner.v1.ExecuteBatchDmlRequest\032*.googl"
          + "e.spanner.v1.ExecuteBatchDmlResponse\"V\202\323"
          + "\344\223\002P\"K/v1/{session=projects/*/instances/"
          + "*/databases/*/sessions/*}:executeBatchDml:\001*\022\221\001\n"
          + "\004Read\022\036.google.spanner.v1.ReadRe"
          + "quest\032\034.google.spanner.v1.ResultSet\"K\202\323\344"
          + "\223\002E\"@/v1/{session=projects/*/instances/*/databases/*/sessions/*}:read:\001*\022\254\001\n\r"
          + "StreamingRead\022\036.google.spanner.v1.ReadReque"
          + "st\032#.google.spanner.v1.PartialResultSet\""
          + "T\202\323\344\223\002N\"I/v1/{session=projects/*/instanc"
          + "es/*/databases/*/sessions/*}:streamingRead:\001*0\001\022\311\001\n"
          + "\020BeginTransaction\022*.google.spanner.v1.BeginTransactionRequest\032\036.googl"
          + "e.spanner.v1.Transaction\"i\332A\017session,opt"
          + "ions\202\323\344\223\002Q\"L/v1/{session=projects/*/inst"
          + "ances/*/databases/*/sessions/*}:beginTransaction:\001*\022\353\001\n"
          + "\006Commit\022 .google.spanner."
          + "v1.CommitRequest\032!.google.spanner.v1.CommitResponse\"\233\001\332A"
          + " session,transaction_id,mutations\332A(session,single_use_transacti"
          + "on,mutations\202\323\344\223\002G\"B/v1/{session=project"
          + "s/*/instances/*/databases/*/sessions/*}:commit:\001*\022\260\001\n"
          + "\010Rollback\022\".google.spanner.v1.RollbackRequest\032\026.google.protobuf.Emp"
          + "ty\"h\332A\026session,transaction_id\202\323\344\223\002I\"D/v1"
          + "/{session=projects/*/instances/*/databases/*/sessions/*}:rollback:\001*\022\267\001\n"
          + "\016PartitionQuery\022(.google.spanner.v1.PartitionQue"
          + "ryRequest\032$.google.spanner.v1.PartitionR"
          + "esponse\"U\202\323\344\223\002O\"J/v1/{session=projects/*"
          + "/instances/*/databases/*/sessions/*}:partitionQuery:\001*\022\264\001\n\r"
          + "PartitionRead\022\'.google.spanner.v1.PartitionReadRequest\032$.goog"
          + "le.spanner.v1.PartitionResponse\"T\202\323\344\223\002N\""
          + "I/v1/{session=projects/*/instances/*/dat"
          + "abases/*/sessions/*}:partitionRead:\001*\022\310\001\n\n"
          + "BatchWrite\022$.google.spanner.v1.BatchWriteRequest\032%.google.spanner.v1.BatchWrit"
          + "eResponse\"k\332A\027session,mutation_groups\202\323\344"
          + "\223\002K\"F/v1/{session=projects/*/instances/*"
          + "/databases/*/sessions/*}:batchWrite:\001*0\001"
          + "\032w\312A\026spanner.googleapis.com\322A[https://ww"
          + "w.googleapis.com/auth/cloud-platform,htt"
          + "ps://www.googleapis.com/auth/spanner.dataB\221\002\n"
          + "\025com.google.spanner.v1B\014SpannerProtoP\001Z5cloud.google.com/go/spanner/apiv1/s"
          + "pannerpb;spannerpb\252\002\027Google.Cloud.Spanne"
          + "r.V1\312\002\027Google\\Cloud\\Spanner\\V1\352\002\032Google::Cloud::Spanner::V1\352A_\n"
          + "\037spanner.googleapis.com/Database\022<projects/{project}/inst"
          + "ances/{instance}/databases/{database}P\000b\006proto3"
    };
    descriptor =
