  ...
  static {
    java.lang.String[] descriptorData = {
      "\n=google/spanner/admin/database/v1/spann"
          ...
          + "\014\n\004name\030\001 \001(\t\022H\n\013source_type\030\002 \001(\01623.goo"
          + "gle.spanner.admin.database.v1.RestoreSou"
          + "rceType\022C\n\013backup_info\030\003 \001(\0132,.google.sp"
          + "anner.admin.database.v1.BackupInfoH\000\022E\n\010"
          + "progress\030\004 \001(\01323.google.spanner.admin.da"
          + "tabase.v1.OperationProgress\022/\n\013cancel_ti"
          + "me\030\005 \001(\0132\032.google.protobuf.Timestamp\022(\n "
          + "optimize_database_operation_name\030\006 \001(\tB\r"
          ...
          + "seAdmin\022\300\001\n\rListDatabases\0226.google.spann"
          + "er.admin.database.v1.ListDatabasesReques"
          + "t\0327.google.spanner.admin.database.v1.Lis"
          + "tDatabasesResponse\">\202\323\344\223\002/\022-/v1/{parent="
          + "projects/*/instances/*}/databases\332A\006pare"
          + "nt\022\244\002\n\016CreateDatabase\0227.google.spanner.a"
          + "dmin.database.v1.CreateDatabaseRequest\032\035"
          + ".google.longrunning.Operation\"\271\001\202\323\344\223\0022\"-"
          + "/v1/{parent=projects/*/instances/*}/data"
          + "bases:\001*\332A\027parent,create_statement\312Ad\n)g"
          + "oogle.spanner.admin.database.v1.Database"
          + "\0227google.spanner.admin.database.v1.Creat"
          + "eDatabaseMetadata\022\255\001\n\013GetDatabase\0224.goog"
          + "le.spanner.admin.database.v1.GetDatabase"
          + "Request\032*.google.spanner.admin.database."
          + "v1.Database\"<\202\323\344\223\002/\022-/v1/{name=projects/"
          + "*/instances/*/databases/*}\332A\004name\022\235\002\n\021Up"
          + "dateDatabaseDdl\022:.google.spanner.admin.d"
          + "atabase.v1.UpdateDatabaseDdlRequest\032\035.go"
          + "ogle.longrunning.Operation\"\254\001\202\323\344\223\002:25/v1"
          + "/{database=projects/*/instances/*/databa"
          + "ses/*}/ddl:\001*\332A\023database,statements\312AS\n\025"
          + "google.protobuf.Empty\022:google.spanner.ad"
          + "min.database.v1.UpdateDatabaseDdlMetadat"
          + "a\022\243\001\n\014DropDatabase\0225.google.spanner.admi"
          + "n.database.v1.DropDatabaseRequest\032\026.goog"
          + "le.protobuf.Empty\"D\202\323\344\223\0023*1/v1/{database"
          + "=projects/*/instances/*/databases/*}\332A\010d"
          + "atabase\022\315\001\n\016GetDatabaseDdl\0227.google.span"
          + "ner.admin.database.v1.GetDatabaseDdlRequ"
          + "est\0328.google.spanner.admin.database.v1.G"
          + "etDatabaseDdlResponse\"H\202\323\344\223\0027\0225/v1/{data"
          + "base=projects/*/instances/*/databases/*}"
          + "/ddl\332A\010database\022\353\001\n\014SetIamPolicy\022\".googl"
          + "e.iam.v1.SetIamPolicyRequest\032\025.google.ia"
          + "m.v1.Policy\"\237\001\202\323\344\223\002\206\001\">/v1/{resource=pro"
          + "jects/*/instances/*/databases/*}:setIamP"
          + "olicy:\001*ZA\"</v1/{resource=projects/*/ins"
          + "tances/*/backups/*}:setIamPolicy:\001*\332A\017re"
          + "source,policy\022\344\001\n\014GetIamPolicy\022\".google."
          + "iam.v1.GetIamPolicyRequest\032\025.google.iam."
          + "v1.Policy\"\230\001\202\323\344\223\002\206\001\">/v1/{resource=proje"
          + "cts/*/instances/*/databases/*}:getIamPol"
          + "icy:\001*ZA\"</v1/{resource=projects/*/insta"
          + "nces/*/backups/*}:getIamPolicy:\001*\332A\010reso"
          + "urce\022\234\002\n\022TestIamPermissions\022(.google.iam"
          + ".v1.TestIamPermissionsRequest\032).google.i"
          + "am.v1.TestIamPermissionsResponse\"\260\001\202\323\344\223\002"
          + "\222\001\"D/v1/{resource=projects/*/instances/*"
          + "/databases/*}:testIamPermissions:\001*ZG\"B/"
          + "v1/{resource=projects/*/instances/*/back"
          + "ups/*}:testIamPermissions:\001*\332A\024resource,"
          + "permissions\022\376\001\n\014CreateBackup\0225.google.sp"
          + "anner.admin.database.v1.CreateBackupRequ"
          + "est\032\035.google.longrunning.Operation\"\227\001\202\323\344"
          + "\223\0025\"+/v1/{parent=projects/*/instances/*}"
          + "/backups:\006backup\332A\027parent,backup,backup_"
          + "id\312A?\n\006Backup\0225google.spanner.admin.data"
          + "base.v1.CreateBackupMetadata\022\245\001\n\tGetBack"
          + "up\0222.google.spanner.admin.database.v1.Ge"
          + "tBackupRequest\032(.google.spanner.admin.da"
          + "tabase.v1.Backup\":\202\323\344\223\002-\022+/v1/{name=proj"
          + "ects/*/instances/*/backups/*}\332A\004name\022\310\001\n"
          + "\014UpdateBackup\0225.google.spanner.admin.dat"
          + "abase.v1.UpdateBackupRequest\032(.google.sp"
          + "anner.admin.database.v1.Backup\"W\202\323\344\223\002<22"
          + "/v1/{backup.name=projects/*/instances/*/"
          + "backups/*}:\006backup\332A\022backup,update_mask\022"
          + "\231\001\n\014DeleteBackup\0225.google.spanner.admin."
          + "database.v1.DeleteBackupRequest\032\026.google"
          + ".protobuf.Empty\":\202\323\344\223\002-*+/v1/{name=proje"
          + "cts/*/instances/*/backups/*}\332A\004name\022\270\001\n\013"
          + "ListBackups\0224.google.spanner.admin.datab"
          + "ase.v1.ListBackupsRequest\0325.google.spann"
          + "er.admin.database.v1.ListBackupsResponse"
          + "\"<\202\323\344\223\002-\022+/v1/{parent=projects/*/instanc"
          + "es/*}/backups\332A\006parent\022\261\002\n\017RestoreDataba"
          + "se\0228.google.spanner.admin.database.v1.Re"
          + "storeDatabaseRequest\032\035.google.longrunnin"
          + "g.Operation\"\304\001\202\323\344\223\002:\"5/v1/{parent=projec"
          + "ts/*/instances/*}/databases:restore:\001*\332A"
          + "\031parent,database_id,backup\312Ae\n)google.sp"
          + "anner.admin.database.v1.Database\0228google"
          + ".spanner.admin.database.v1.RestoreDataba"
          + "seMetadata\022\344\001\n\026ListDatabaseOperations\022?."
          + "google.spanner.admin.database.v1.ListDat"
          + "abaseOperationsRequest\032@.google.spanner."
          + "admin.database.v1.ListDatabaseOperations"
          + "Response\"G\202\323\344\223\0028\0226/v1/{parent=projects/*"
          + "/instances/*}/databaseOperations\332A\006paren"
          + "t\022\334\001\n\024ListBackupOperations\022=.google.span"
          + "ner.admin.database.v1.ListBackupOperatio"
          + "nsRequest\032>.google.spanner.admin.databas"
          + "e.v1.ListBackupOperationsResponse\"E\202\323\344\223\002"
          + "6\0224/v1/{parent=projects/*/instances/*}/b"
          + "ackupOperations\332A\006parent\032x\312A\026spanner.goo"
          + "gleapis.com\322A\\https://www.googleapis.com"
          + "/auth/cloud-platform,https://www.googlea"
          + "pis.com/auth/spanner.adminB\254\002\n$com.googl"
          + "e.spanner.admin.database.v1B\031SpannerData"
          + "baseAdminProtoP\001ZHgoogle.golang.org/genp"
          + "roto/googleapis/spanner/admin/database/v"
          + "1;database\252\002&Google.Cloud.Spanner.Admin."
